...
![](./image/logo_netflix.png){fig-width="200" fig-align="center" fig-pos="center"}
:::
...
![](./image/logo_lyft.png){fig-width="200" fig-align="center"}
:::
...
![](./image/logo_ob.png){fig-width="200" fig-align="center"}
:::
...
![](./image/logo_transform.png){width="200"}
...
![State of the Octoverse 2021, GitHub](./image/lang_rank.png)
...
![Quarto rendering a Jupyter notebook written with nbdev](./image/nb_quarto.png)
...
![`@patch` decorator from fastcore](./image/patch.png){fig-align="center" width="600"}
